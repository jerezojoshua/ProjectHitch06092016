 ...
 */
public class DriverBackgroundTask extends AsyncTask<String,Void,String> {

    Context ctx;

    DriverBackgroundTask(Context ctx){
        this.ctx = ctx;
    }
...
/*            String seat5 = params[24];
            String seat6 = params[25];
            String seat7 = params[26];*/
            ...
            try {
                ...
                IS.close();
                return "Adding Schedule/DriverTrips Success...";
